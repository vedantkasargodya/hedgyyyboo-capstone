...
const PLACEMENTS = {
  ...
  "4.5": [
    ...
    { type: "figure", file: "figI_llm_usage.png", n: 8,
...
const tocPage = [
  ...
  ...[
    ...
    ["Fig. 8", "LLM usage analytics (decisions + latency)",      "38"],
    ["Fig. 9", "Existing pricing model figures (grouped in §3.3)","21"],
...
const appendixD = [
  ...
  dtable(
    ...
    [
      ...
      ["Fig. 6", "PC1-PC3 loadings vs tenor: Level, Slope, Curvature",     "34"],
      ["Fig. 7", "Auto-PM realised equity curve and drawdown",             "36"],
      ["Fig. 8", "LLM usage analytics (decisions + latency)",              "38"],
